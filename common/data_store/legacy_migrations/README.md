...
- ``common/data_store/migrations/001_phase1_tables.py``
- ``common/data_store/migrations/002_extraction_tables.py``
...
(module ``common/data_store/migrations.py``).

Run legacy scripts directly, e.g.:

```bash
python common/data_store/legacy_migrations/001_phase1_tables.py
```
