...
|---------|------|--------|--------|----------------|:---------:|:-------------:|----------|
| `v1-baseline` | 2026-04-23 | Bryan + Emilio | v1 (partial-credit intent, lenient refusal) | Initial baseline — 90 golden questions, unmodified prompts, in-process pipeline | **0.875** | 0.260 (n=50) | `eval/runs/qa-v1-baseline.json` |
...
| `v2.1-post-seed-fix` | 2026-04-27 | Bryan | v2 (same scorer as v2) | Re-run post-PR #291 aggregate table seed fix; confirms data-seed was sole cause of 0.06 answerability collapse | — | **0.340** (n=50) | [`eval/runs/findingsv2.1.md`](findingsv2.1.md) · [`eval/runs/qa-v2.1-post-seed-fix.json`](qa-v2.1-post-seed-fix.json) |
