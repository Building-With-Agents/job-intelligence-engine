# AGENTS.md — Job Intelligence Engine

This file is the primary context document for Codex.
...
Anthropic model IDs (`Codex-haiku-4-5`, `Codex-sonnet-4-6`,
`Codex-opus-4-6`, etc.) in agent code, `.cursor/rules/*.mdc` contracts,
