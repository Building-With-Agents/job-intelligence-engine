...
(see :mod:`enrichment.classifiers.spam_preview`). Writes optional HTML report.
...
PowerShell (repo root)::
    ...
    python -m scripts.run_spam_detection_preview --limit 20 --html-out data/rendered/spam_preview.html
"""
...
from enrichment.classifiers.spam_preview_html import render_spam_preview_html  # noqa: E402
